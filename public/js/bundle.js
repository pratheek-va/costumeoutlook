...
},{"jquery":"../../node_modules/jquery/dist/jquery.js"}],"login.js":[function(require,module,exports) {
"use strict";
...
_toastr.default.options.closeMethod = "fadeOut";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              _toastr.default.success("Logged In sucessfully", "success");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _toastr.default.error("Error logging out! Try again.", "error");
...
exports.displayRazorPay = void 0;
...
var displayRazorPay = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(order) {
    var res, data, options, rzp1;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.post("/payment/razorpay", {
              order: order
            });
  ...
  return function displayRazorPay(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.displayRazorPay = displayRazorPay;
},{"axios":"../../node_modules/axios/index.js"}],"cart.js":[function(require,module,exports) {
"use strict";
...
var deleteFromCart = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _toastr.default.error(_context2.t0.response.data.message, "error");
  ...
  return function deleteFromCart(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var goToAddress = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              window.location.href = "/address/".concat(res.data.token);
            }
          ...
          case 7:
            ...
            _toastr.default.error(_context3.t0.response.data.message, "error");
  ...
  return function goToAddress(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.goToAddress = goToAddress;
},{"axios":"../../node_modules/axios/index.js","toastr":"../../node_modules/toastr/toastr.js"}],"product.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _toastr.default.error(_context2.t0.res.data.message, "error");
...
var paymentButton = document.querySelector("#gform");
var addToCartButton = document.querySelector("#btn");
var buyNowButton = document.querySelector("#btn1");
...
if (signupForm) signupForm.addEventListener("submit", function (e) {
  ...
  (0, _signup.signup)(name, phoneNumber, email, password);
});
if (paymentButton) paymentButton.addEventListener("submit", function (e) {
  e.preventDefault();
  var order = {
  ...
  (0, _payment.displayRazorPay)(order);
});
if (addToCartButton) addToCartButton.addEventListener("click", function (e) {
  var size = "";
  var inputs = document.querySelectorAll(".rb");
  inputs.forEach(function (input) {
    if (input.checked == true) size = input.value;
  });

  if (size == "") {
    _toastr.default.warning("Please provide your size", "Warning");
...
if (buyNowButton) buyNowButton.addEventListener("click", function (e) {
  e.preventDefault();
  var size = "";
  var inputs = document.querySelectorAll(".rb");
  inputs.forEach(function (input) {
  ...
  if (size == "") {
    _toastr.default.warning("Atleast 6 characters should be there", "Failed");
...
if (deleteButtons) deleteButtons.forEach(function (deleteButton) {
...
if (addProductButton) addProductButton.addEventListener("submit", function (e) {
  e.preventDefault();
  var sizes = [];
  var images = [];
    ...
    if (i != "length") {
      ...
      reader.onload = function (theFile) {
        return function (e) {
          ...
          var base64String = "data:image/".concat(theFile.name.split(".")[1], ";base64,") + window.btoa(binaryData);
